...
describe('express-hbs', function() {
  describe('cache', function() {
    ...
    it('should not cache layouts in `development`', function(done) {
        ...
        .end(function(err) {
          ...
          request(mock.app)
            ...
            .end(function(err) {
              ...
              var filename = path.resolve(__dirname, '../example/views/layouts/default.hbs');
    ...
    it('should cache layouts in `production` reading file once', function(done) {
      var mock = createApp('production');

      // reads layouts from fs once
      request(mock.app)
        .get('/')
        .end(function(err) {
          assert.ifError(err);
