...
describe('express-hbs', function() {
  ...
  describe('defaults', function() {
    ...
    it('should render using default layouts', function(done) {
      request(app)
        .get('/')
    ...
    it('should render layouts specified as locals', function(done) {
      request(app)
        .get('/veggies')
        .expect(/PROGRAMMATIC LAYOUT/, done);
    });

    it('should render nested layouts correctly when first layouts is specified as locals', function(done) {
      request(app)
        .get('/veggies/carrot')
